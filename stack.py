...
class Stack(object):
    ...
    def empty(self):
        ...
        # 1 Approach
        # for i in self. _list:
        #     empty_list = self._list.pop([i])

        # return empty_list

        # Another approach
        # empty_list = self._list.clear()
        ...
        # Another approach
        # return len(self._list).pop()

        # Another approach
        # return pop(len(self._list))

        # Another attmept: still not working. returns 4 and
        # when check length() it returns 2 (deletes fish but not the rest)
        # return self._list[:]

        # Works
        self._list = []
        empty_list = self._list
